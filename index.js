...
import { loadPlugins, pluginStore } from "./src/lib/jexk-plugins.js";
import { initDatabase, getDatabase } from "./src/lib/jexk-database.js";
import {
  initScheduler,
  loadScheduledMessages,
  startGroupScheduleChecker,
  startSewaChecker,
} from "./src/lib/jexk-scheduler.js";
import { handleAntiTagSW } from "./src/lib/jexk-group-protection.js";
import { initSholatScheduler } from "./src/lib/jexk-sholat-scheduler.js";
import { initNotifScheduler } from "./src/lib/jexk-notif-scheduler.js";
import { initAutoJpmScheduler } from "./src/lib/jexk-auto-jpm.js";
import { startMemoryMonitor } from "./src/lib/jexk-memory-monitor.js";
import { startTempCleaner } from "./src/lib/jexk-temp-cleaner.js";
import { startDailyPruner } from "./src/lib/jexk-data-pruner.js";
import { preloadAssets } from "./src/lib/jexk-asset-manager.js";
import {
  logger,
  c,
  playBootSequence,
  ...
  logErrorBox,
  divider,
} from "./src/lib/jexk-logger.js";

await import("./src/lib/jexk-agent.js")
    ...
    (eventType, filename) => {
      ...
      const timeout = setTimeout(async () => {
        ...
        if (!fs.existsSync(fullPath)) {
          ...
          const { unloadPlugin } = await import("./src/lib/jexk-plugins.js");
        ...
        try {
          ...
          const { hotReloadPlugin } =
            await import("./src/lib/jexk-plugins.js");
      ...
      if (update.connection === "open") {
        ...
        try {
          const { startOtpPoller: _startOtp } =
            await import("./src/lib/jexk-otp-poller.js");
          _startOtp(sock);
        } catch { }

        try {
          const { getAllJadibotSessions, restartJadibotSession } =
            await import("./src/lib/jexk-jadibot-manager.js");
