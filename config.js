import { getDatabase } from "./src/lib/jexk-database.js";
import * as ownerPremiumDb from "./src/lib/jexk-premium-db.js";

//  utamakan baca object config sampai bawah
const config = {
  info: {
    website: "https://bram-bayar.vercel.app",
    grupwa: "https://chat.whatsapp.com/xxxx",
  },

  owner: {
    name: "Bram Is Here", // Nama owner
    number: ["6285379307765"], // Format: 628xxx (tanpa + atau 0)
  },

  session: {
    folderName: "session",
    pairingNumber: "6285379307765", // Nomor WA yang akan di-pair, ini penting
    usePairingCode: true, // true = Pairing Code, false = QR Code
  },

  bot: {
    name: "Bram Bot", // Nama bot
    version: "1.0", // Versi bot
    developer: "Bram", // Nama developer
  },

  assets: {
    "jexk-daftar": "./assets/image/jexk-daftar.png",
    "jexk-demote": "./assets/image/jexk-demote.png",
    "jexk-fishit": "./assets/image/jexk-fishit.jpg",
    "jexk-games": "./assets/image/jexk-games.jpg",
    "jexk-landscape": "./assets/image/jexk-landscape.jpg",
    "jexk-levelup": "./assets/image/jexk-levelup.jpg",
    "jexk-minecraft": "./assets/image/jexk-minecraft.jpg",
    "jexk-promote": "./assets/image/jexk-promote.png",
    "jexk-rpg": "./assets/image/jexk-rpg.jpg",
    "jexk-rules": "./assets/image/jexk-rules.jpg",
    "jexk-store": "./assets/image/jexk-store.png",
    "jexk-v8": "./assets/image/jexk-v8.jpg",
    "jexk-winner": "./assets/image/jexk-winner.jpg",
    "jexk": "./assets/image/jexk.png",
    "jexk2": "./assets/image/jexk2.jpg",
    "jexk3": "./assets/image/jexk3.jpg",
    "pp-kosong": "./assets/image/pp-kosong.jpg",
    "jexk-mp4": "./assets/video/jexk-mp4.mp4",
    "jexk-mp3": "./assets/audio/jexk-mp3.mp3",
    "jexk-font": "./assets/jexk-font.ttf",
    "jexk-kertas": "./assets/image/jexk-kertas.jpg",
  ...
  vercel: {
    ...
    token: "uRKJSTt0L4RaSkiMj41QTkxM", // Vercel Token untuk fitur deploy ( Kalau .deploy mau work, ini wajib di isi )
  },

  payment: {
    qrisUrl: "https://bram-bayar.vercel.app",
    methods: [
    ...
    banks: [],
    customText: "https://bram-bayar.vercel.app",
  },
  ...
  donasi: {
    ...
    qris: "https://bram-bayar.vercel.app",
  },
  ...
  sticker: {
    packname: "Bram", // Nama pack sticker
    author: "tata", // Author sticker
  },
