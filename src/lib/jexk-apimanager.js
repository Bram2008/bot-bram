...
/**
 * @typedef {Object} jexkApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} jexkApiProviderShape
 * @property {string} baseURL
 * @property {jexkApiAuthShape} [auth]
...
/**
 * @typedef {Object} jexkApiRequestOptions
...
/**
 * @typedef {Object} jexkApiMultipartFile
 ...
 */
class jexkApiProvider {
  /**
   * @param {jexkApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {jexkApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {jexkApiMultipartFile[]|Object<string, any>} [files]
   * @param {jexkApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends jexkApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends jexkApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends jexkApiProvider {
...
class ApiFaaProvider extends jexkApiProvider {
...
class jexkMainApiProvider extends jexkApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends jexkApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends jexkApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends jexkApiProvider {
...
class AzbryApiProvider extends jexkApiProvider {
...
class YuulabsApiProvider extends jexkApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends jexkApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends jexkApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal jexk.
 */
class jexkApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @param {jexkApiProviderShape} cfg
   * @returns {jexkApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<jexkApiProviderShape>} cfg
   * @returns {jexkApiProvider}
   */
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || jexkApiProvider;
...
const jexkApi = new jexkApiManager();

export { jexkApiManager, jexkApiProvider, jexkApi };
export default jexkApi;
